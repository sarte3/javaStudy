...
// 이런 경우의 작업을 처리할 때는 한 스레드가 메소드에 접근해서 예매 작업을 실행할 때에는
...
public class SynchronizedEx01 {
	...
	public static void main(String[] args) {
		...
		Thread tr1 = new Thread(tck,"hong 구매자");
		Thread tr2 = new Thread(tck,"GD 구매자");
...
class Ticket01 implements Runnable {
	...
	public synchronized void getTicket() {
		...
		System.out.println("- 현재 잔여 좌석 수 : "+ticketNum);
	}
